...
V_tol = 10; # velocity tolerance (m/s) for start and end of motion with sigmoid
...
w = 800; # width (X-dimension) of working area (m)
l = 800; # length (Y-dimension) of working area (m)
ht = 800; # height (Z-dimension) of top winches (m)
hb = 450; # height (Z-dimension of bottom winches (m)
e = 50; # half-length (Y-dimension) of effector (m)
f = 50; # half-width (X-dimension) of effector (m)
g = 50; # half-height (Z-dimension) of effector (m)
...
spool_radius = 20; # spool radius (m)
